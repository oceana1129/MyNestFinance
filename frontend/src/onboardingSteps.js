...
const categoryDetailSteps = [
  // utilities
  {
    ...
    blurb: {
      title: "Utilities",
      color: "amber",
      text: "What helps your home run smoothly",
      icon: Lightbulb,
    },
    blocks: [
      {
  ...
  // transportation
  {
    ...
    blurb: {
      ...
      color: "slate",
      text: "Getting where you need to go.",
      icon: Car,
    },
    blocks: [
      {
  ...
  // healthcare
  {
    ...
    blurb: {
      title: "Healthcare",
      color: "blue",
      text: "Let's make space for your health and well being.",
      icon: Stethoscope,
    },
    blocks: [
      {
        ...
        options: [
          ...
          {
            value: "ot-pt-speech-therapy",
            label: "OT / PT / Speech therapy",
            icon: BookHeart,
          },
  ...
  // special equipment
  {
    ...
    blurb: {
      ...
      color: "indigo",
      text: "Accessibility and support needs are important parts of everyday life.",
      icon: Accessibility,
    },
    blocks: [
      {
  ...
  // personal needs
  {
    ...
    blurb: {
      ...
      color: "rose",
      text: "The little things that help you feel comfortable, confident, and cared for.",
      icon: Lightbulb,
    },
    blocks: [
      {
  ...
  // pets
  {
    ...
    blurb: {
      title: "Pets",
      color: "mauve",
      text: "Let's plan for the joy these little guys bring to your life.",
      icon: PawPrint,
    },
    blocks: [
      {
  ...
  // education
  {
    ...
    blurb: {
      title: "Education",
      color: "teal",
      text: "Learning and growth are investments in your future.",
      icon: GraduationCap,
    },
    blocks: [
      {
  ...
  // child care
  {
    ...
    blurb: {
      title: "Child Care",
      color: "yellow",
      text: "Caring for others comes with a lot to think about.",
      icon: Baby,
    },
    blocks: [
      {
        ...
        options: [
          ...
          {
            value: "school-care",
            label: "Before / After school care",
            icon: School,
          },
          {
  ...
  // miscellaneous
  {
    ...
    blurb: {
      title: "Miscellaneous",
      color: "orange",
      text: "Some expenses don't fit neatly into a category.",
      icon: Package,
    },
    blocks: [
      {
  ...
  // savings
  {
    ...
    blurb: {
      title: "Savings",
      color: "emerald",
      text: "Planning ahead can create more stability, flexibility, and peace of mind.",
      icon: HandCoins,
    },
    blocks: [
      {
...
const completeStep = {
  ...
  finalCaption:
    "You can add, edit, or remove categories and items at any time from your dashboard.",
};
