...
const Button = ({
    ...
    const variantStyles = {
        ...
        glass: "bg-white bg-opacity-70 text-slate-700 border-2 border-white shadow-md hover:bg-opacity-100",
        dotted: "bg-white border-2 border-dashed border-slate-300 text-slate-700 hover:bg-slate-50",
    };
