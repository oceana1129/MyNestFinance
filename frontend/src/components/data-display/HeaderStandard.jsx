  ...
  return (
    <div className="flex gap-8">
      {Icon && (
        <div>
          <div
            className={`p-4 ${colors.bgExtraLight} rounded-2xl border-4 border-white shadow-lg`}
          >
            <Icon size={32} className={colors.text} />
          </div>
        </div>
      )}
      <div className={`flex gap-2 flex-1 flex-col ${align} ${className}`}>
        {subheader && (
        ...
        {subheader2 && (
          <p className="font-bold uppercase tracking-wide ${}">{subheader2}</p>
        )}
